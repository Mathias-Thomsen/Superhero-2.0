...
public class Controller {
    ...
    public void getSortPrimaryAndSecondary(String primaryAttribute, String secondaryAttribute) {
        database.sortPrimaryAndSecondary(primaryAttribute, secondaryAttribute);
    }
